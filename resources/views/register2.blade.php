...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="dist/css/dist/AdminLTE.css">
  <!-- iCheck -->
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="public/home/" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Direcci&oacute;n Fiscal">
        <span class="glyphicon glyphicon-print form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Direcci&oacute;n de Env&iacute;o">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="N° Cuenta">
    ...
    <a href="/" class="text-center">Si ya eres miembro ingresa aqu&iacute;</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
