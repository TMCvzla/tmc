                    ...
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                -->
                                <input id="name" name="name" type="text" class="form-control" placeholder="Nombre Apellido o Raz&oacute;n Social" required autofocus>
                        ...
                        <div class="input-group">
                            ...
                            <input name="ci" id="ci" type="text" class="form-control" placeholder="Documento de Identidad">
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        <input name="dirfiscal" id="dirfiscal" type="text" class="form-control" placeholder="Direcci&oacute;n Fiscal">
                      ...
                      <div class="form-group has-feedback">
                        <input name="direnvio" id="direnvio" type="text" class="form-control" placeholder="Direcci&oacute;n de Env&iacute;o">
                      ...
                      <div class="form-group has-feedback">
                        <input name="cuenta" id="cuenta" type="text" class="form-control" placeholder="N° Cuenta">
